...
export default function FaqSection() {
  ...
  const faqs: FaqItem[] = [
    ...
    { id: 'q-06', code: 'Q06', category: 'TRACKS', question: 'How does track selection and problem statement allocation work?', answer: 'Problem statements across Agentic Finance, Web3 & DeFi, Supply Chain Finance, FinSec & Cyber Finance, and Open Innovation will be officially released on 12 August. Teams select their preferred track during Round 1 submission.' },
